...
use ColdkitchenBundle\Entity\Partner;
use ColdkitchenBundle\Form\PartnerType;
...
class PartnerController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('ColdkitchenBundle:Partner')->findAll();
     ...
     * @Method("POST")
     * @Template("ColdkitchenBundle:Partner:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('ColdkitchenBundle:Partner')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("ColdkitchenBundle:Partner:edit.html.twig")
     */
